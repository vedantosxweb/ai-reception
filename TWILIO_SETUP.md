...
Your Twilio credentials should be added to the `.env` file:
...
ENABLE_SMS=true
# In production keep strict signature validation enabled:
TWILIO_WEBHOOK_STRICT_VALIDATION=true
```
...
Click on your phone number **YOUR_TWILIO_PHONE_NUMBER**

#### Voice & Fax Settings:

| Setting | URL |
|---------|-----|
| **A CALL COMES IN** | `https://YOUR-DOMAIN/api/webhooks/twilio/voice` |
| **Primary Handler Fails** | Leave empty |
| **Call Status Changes** | `https://YOUR-DOMAIN/api/webhooks/twilio/status` |
...
**Example with Vercel:**
```
https://ai-receptionist.vercel.app/api/webhooks/twilio/voice
```
...
│                      INCOMING CALL FLOW                         │
├─────────────────────────────────────────────────────────────────┤
│  1. Caller dials YOUR_TWILIO_PHONE_NUMBER                                   │
...
| Setting | URL |
|---------|-----|
| **A MESSAGE COMES IN** | `https://YOUR-DOMAIN/api/webhooks/twilio/sms` |
...
- ✅ Connected to your Twilio number (YOUR_TWILIO_PHONE_NUMBER)
